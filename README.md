...
Projects that are currently underway are:
 - [Verifiable Index v1](./vindex/v1/): a verifiable index (map) built on top of a single Input Log (see [Quickstart](./vindex/v1/QUICKSTART.md))
