...
- [**WASM MapFn Plugin SDK & Host Runtime**](./mapfn/README.md): Sandboxed deterministic mapping specification, guest ABI, Wazero host runtime, multi-language SDKs (Go, TinyGo, Rust), and verification CLI.
