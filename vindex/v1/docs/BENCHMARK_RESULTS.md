# Empirical Benchmark Evaluation & Backfill Verdict
...
Therefore, **Backfill Mode is unjustified and should be completely pruned** from the VIndex v1 codebase in favor of unified normal serving mode.
...
### Final Verdict: **PRUNE BACKFILL MODE**
