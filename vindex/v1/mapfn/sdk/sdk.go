...
var (
	registeredEmitMapFunc EmitMapFunc
)

// RegisterEmit registers a streaming plugin using an emitter callback.
func RegisterEmit(fn EmitMapFunc) {
	registeredEmitMapFunc = fn
}
