...
## Testing with `vindex-wasm`

You can test and benchmark the precompiled binaries using `vindex-wasm`:

```bash
# 1. Test single leaf
go run ./vindex/v1/cmd/vindex-wasm test \
...
go run ./vindex/v1/cmd/vindex-wasm verify-determinism \
