...
var (
	...
	mode               = flag.String("mode", "publisher", "Daemon operation mode: 'publisher' (default).")
	oneShot            = flag.Bool("oneshot", false, "Run publisher sync once against log tip and exit.")
