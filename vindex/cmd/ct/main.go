...
var (
	inputLogUrl          = flag.String("static_ct_log_url", "", "Base URL of the static CT log to index")
...
func newStaticCTInputLogFromFlags() *staticCTInputLog {
	...
	c, err := sunlight.NewClient(&sunlight.ClientConfig{
		MonitoringPrefix: *inputLogUrl,
		PublicKey:        nil,
		HTTPClient:       http.DefaultClient,
		UserAgent:        "mhutchinson@google.com",
	})
	if err != nil {
		klog.Exitf("failed to create sunlight client: %v", err)
	}
